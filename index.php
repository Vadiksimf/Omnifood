...
<head>
    ...
    <meta name="description" content="Omnifood is a awesome food delivery service with the main point to provide healthly food">
    <meta name="keywords" content="Food, healthly, taste, yummy, delivery">
    
    <!-- Подключение "нормального" отображения в разных браузерах -->
    <link rel="stylesheet" type="text/css" href="vendors/css/normalize.css">
    <!-- Подключение грид сетки -->
    <link rel="stylesheet" type="text/css" href="vendors/css/grid.css">
    <!-- Animate.css -->
    <link rel="stylesheet" type="text/css" href="vendors/css/animate.min.css">
    <!-- Основной CSS файл -->
    <link rel="stylesheet" type="text/css" href="resources/css/style.css">
    <!-- Подключение шрифта проекта -->
    ...
    <header>
        <nav>
            <div class="row">
                ...
                <a class="mobile-nav-icon js--nav-burger"><i class="ion-navicon-round"></i></a>
            </div>
        </nav>
        ...
        <section class="section-steps" id="steps">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img class="app-screen js--wp-2" src="resources/img/app-iPhone.png" alt="Viggie-food app on iPhone">
                </div>
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="resources/img/Apple-App-Store.png" alt="App Store Button"></a>
            ...
            <div class="row">
                ...
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
                            <img src="resources/img/customer-2.jpg" alt="Milton Chapman">
                            Milton Chapman
                        </cite>
                </blockquote>
                </div>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li>
                                    <i class="ion-ios-checkmark-empty icon-small"></i>1 meal 10 days/month
                                </li>
                                <li>
                                    <i class="ion-ios-checkmark-empty icon-small"></i>Order 24/7
                                </li>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box">
                        <div>
                            ...
                            <p class="plan-price-meal">&nbsp;</p> <!-- Добавляет пробел и решает проблему выравнивания -->
                        </div>
                        <div>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <i class="ion-ios-checkmark-empty icon-small"></i>Order from 8 am to 12 pm
                                </li>
                                <li>
            ...
            <div class="map"></div>
                ...
                <div class="row">
                    <form method="post" action="mailer.php" class="contact-form">
                        ...
                        <!-- Внедрение сообщения об ошибках -->
                        <div class="row">
                            <?php  
                                if ($_GET['succes'] == 1) {
                                ...
                                if ($_GET['succes'] == -1) {
                                    echo "<div class=\"form-messages error\">Oops! Something went wrong. Please try it again.</div>";
                                }
                            ?>
                        </div>
...
<!-- FOOTER -->
    ...
    <!-- Определение новых свойств HTML5 для браузеров  -->
    ...
    <!-- Gmaps   -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB0t7voaGTqvsbCQ12MUWEfAquxMkLNBXc"></script>
